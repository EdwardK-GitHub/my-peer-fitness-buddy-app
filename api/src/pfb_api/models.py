...
class Admin(TimestampMixin, Base):
    ...
    reviewed_badge_applications: Mapped[list[BadgeApplication]] = relationship(
...
class BadgeApplication(TimestampMixin, Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=lambda: str(uuid4()))
    user_id: Mapped[str] = mapped_column(ForeignKey("users.id", ondelete="CASCADE"), nullable=False)
    badge_type_id: Mapped[str] = mapped_column(
        ForeignKey("badge_types.id", ondelete="CASCADE"), nullable=False
    )
